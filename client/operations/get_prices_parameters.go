...
func (o *GetPricesParams) WithIncludeHomeConversions(includeHomeConversions *bool) *GetPricesParams {
	o.SetIncludeHomeConversions(includeHomeConversions)
	return o
}
...
func (o *GetPricesParams) SetIncludeHomeConversions(includeHomeConversions *bool) {
	o.IncludeHomeConversions = includeHomeConversions
}
...
func (o *GetPricesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.IncludeHomeConversions != nil {

		// query param includeHomeConversions
		var qrIncludeHomeConversions bool
		if o.IncludeHomeConversions != nil {
			qrIncludeHomeConversions = *o.IncludeHomeConversions
		}
		qIncludeHomeConversions := swag.FormatBool(qrIncludeHomeConversions)
		if qIncludeHomeConversions != "" {
			if err := r.SetQueryParam("includeHomeConversions", qIncludeHomeConversions); err != nil {
				return err
			}
		}
