...
func (a *Client) GetBasePrices(params *GetBasePricesParams) (*GetBasePricesOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetBasePricesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*GetBasePricesOK), nil
...
func (a *Client) GetInstrumentPrice(params *GetInstrumentPriceParams) (*GetInstrumentPriceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetInstrumentPriceParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getInstrumentPrice",
		Method:             "GET",
		PathPattern:        "/instruments/{instrument}/price",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetInstrumentPriceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*GetInstrumentPriceOK), nil
...
func (a *Client) GetInstrumentPriceRange(params *GetInstrumentPriceRangeParams) (*GetInstrumentPriceRangeOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetInstrumentPriceRangeParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getInstrumentPriceRange",
		Method:             "GET",
		PathPattern:        "/instruments/{instrument}/price/range",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetInstrumentPriceRangeReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*GetInstrumentPriceRangeOK), nil
